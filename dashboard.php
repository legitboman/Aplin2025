...
<body style="margin:0; font-family: Arial, sans-serif; background-color: white;">
    <div style="background-color: #03AC0E; padding: 15px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div>
            ...
            <a href="confirmation.php" style="color: white; margin-right: 20px; text-decoration: none;">Confirmation</a>
            <a href="addCategory.php" style="color: white; margin-right: 20px; text-decoration: none;">Add Category</a>
        ...
        <table style="width: 90%; margin: 0 auto; border-collapse: collapse; margin-top: 30px;">
            <thead>
                <tr style="background-color: #03AC0E; color: white;">
                    ...
                    <th style="padding: 12px; border: 1px solid #ccc;">Kategori</th>
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td style="padding: 12px; border: 1px solid #ccc;">
                            <?php
                                ...
                                echo htmlspecialchars($categoryQuery->fetchColumn());
                            ?>
                        </td>
                        <td style="padding: 12px; border: 1px solid #ccc;">
